...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   007-rotative_operations.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: carperez <carperez@student.45madrid>       +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/28 18:02:10 by carperez          #+#    #+#             */
/*   Updated: 2024/05/13 18:26:38 by carperez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_rot_onestack(dPushswap, "aa", bPrint);
	ft_rot_onestack(dPushswap, "bb", bPrint);
...
{
	ft_rev_onestack(dPushswap, "aa", bPrint);
	ft_rev_onestack(dPushswap, "bb", bPrint);
	if ((dPushswap->l_stack_a.n_nodes > 1 || dPushswap->l_stack_b.n_nodes > 1)
		&& bPrint)
		ft_printf("rrr\n");
}
